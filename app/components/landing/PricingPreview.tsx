...
const tiers = [
  {
    ...
    excluded: ['Live trading', 'DCA & Grid Bots'],
  ...
  },
  {
    ...
    excluded: ['DCA & Grid Bots', 'Trading bots'],
  ...
  },
  {
    ...
    popular: true,
    features: ['1:200 leverage', '10% spread discount', 'DCA & Grid Bots', 'Basic signals', '$100 bonus'],
