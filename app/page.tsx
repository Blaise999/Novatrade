...
const pricingTiers = [
  {
    ...
    features: [
      ...
      { text: 'DCA & Grid Bots', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'DCA & Grid Bots access', included: true },
    ...
    highlights: ['$100 welcome bonus', 'DCA & Grid Bots'],
  },
  {
    id: 'elite',
    name: 'Elite',
...
const comparisonFeatures = [
  ...
  { name: 'DCA & Grid Bots', basic: '❌', starter: '❌', pro: '✓', elite: '✓', vip: '✓' },
