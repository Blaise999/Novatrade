...
const markets = [
  ...
  },
  {
    ...
    title: 'Trading Bots',
    subtitle: 'DCA & Grid',
    description: 'Automate your strategy with DCA averaging and Grid trading bots. Data-driven, systematic approaches.',
    features: ['DCA accumulation', 'Grid strategies', 'Risk controls'],
